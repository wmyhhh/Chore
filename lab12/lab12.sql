...
CREATE TABLE big AS
  ...
  FROM finals AS a, finals AS b, sizes AS c, sizes AS d
  WHERE a.hall = c.room AND b.hall = d.room AND a.hall <> b.hall AND a.course = b.course AND c.seats + d.seats >= 1000;
